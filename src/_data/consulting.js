...
// it before this page goes live. Anything commercial (rates, terms,
// availability) is deliberately left null and renders as a placeholder rather
...
export default {
  ...
  positioning:
    "Eight years across engineering, consulting and enterprise architecture — PwC, CANCOM, ORBIS — plus my own practice run alongside them. Austria-based, remote or on-site.",
  ...
  // Not yet decided — placeholders rather than guesses.
  availability: null,
};
