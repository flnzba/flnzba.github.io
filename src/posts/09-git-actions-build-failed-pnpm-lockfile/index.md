---
title: When GitHub Actions Build Fails Due to pnpm-lockfile
description: >-
  What to do when GitHub Actions build fails due to pnpm-lockfile and github
  suggests to run pnpm no frozen-lockfile
date: '2024-11-03'
updated: '2024-11-03'
tags:
  - github actions
...
number: 9
canonical_url: 'https://www.fzeba.com/posts/09-git-actions-build-failed-pnpm-lockfile/'
published: true
---
